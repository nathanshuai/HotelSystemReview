...
namespace HotelSystemReview0.Controllers
{
    public class ClientsController : Controller
    {
        private readonly HotelSystemReview0Context _context;

        public ClientsController(HotelSystemReview0Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Client != null ? 
                          ...
                          Problem("Entity set 'HotelSystemReview0Context.Client'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HotelSystemReview0Context.Client'  is null.");
            }
            var client = await _context.Client.FindAsync(id);
            if (client != null)
            {
